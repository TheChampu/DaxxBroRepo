...
async def get_thumb(videoid: str):
    try:
        ...
        arial = ImageFont.truetype("CutieMusic/assets/font2.ttf", 30)
        font = ImageFont.truetype("CutieMusic/assets/font.ttf", 30)
        title_font = ImageFont.truetype("CutieMusic/assets/font3.ttf", 45)
        ...
        play_icons = Image.open("CutieMusic/assets/play_icons.png")
        ...
        logging.error(f"ᴇʀʀᴏʀ ɢᴇɴᴇʀᴀᴛɪɴɢ ᴛʜᴜᴍʙɴᴀɪʟ ғᴏʀ ᴠɪᴅᴇᴏ {videoid}: {e}")
        traceback.print_exc()
        return None
